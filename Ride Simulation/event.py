...
class DriverRequest(Event):
    ...
    def do(self, dispatcher, monitor):
        ...
        if rider is not None:
            ...
            events.append(Pickup(self.timestamp +
...
class Dropoff(Event):
    """A driver drops off the assigned rider at his/her destination.
    ...
    def do(self, dispatcher, monitor):
        """Drop off the rider at his/her destination and request
        for a new passenger immediately after.
